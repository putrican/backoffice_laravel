...
@section('container')
 {{-- @if ($role == 'Admin') --}}
    <form action="{{ route('orders.store') }}" method="POST" enctype="multipart/form-data" name="crt">
        @csrf
        <div class="row mb-4">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control @error('item') is-invalid @enderror" name="item" value="{{ old('item') }}"
                                                    ...
                                                    <div class="col-md-2 col-sm-2 col-lg-2 col-xs-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number"
                                                                ...
                                                                name="qty" value="{{ old('qty') }}" placeholder="">
